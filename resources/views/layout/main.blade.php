...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('img/smktip2.png') }}" />
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('data_admin', 'data_guru*', 'data_kepsek') ? 'active' : '' }}"
                            ...
                            aria-expanded="{{ Request::is('data_admin', 'data_guru*', 'data_kepsek') ? 'true' : 'false' }}"
                        ...
                        <ul class="sub-nav collapse {{ Request::is('data_admin', 'data_guru*', 'data_kepsek') ? 'show' : '' }}"
                            id="sidebar-user">
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('data_admin') ? 'active' : '' }}"
                                    href="{{ url('data_admin') }}" id="active">
                                    <i class="icon">
                                        <!-- SVG Icon -->
                                    </i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('data_guru*') ? 'active' : '' }}"
                                    href="{{ url('data_guru') }}" id="active">
                                    <i class="icon">
                                        <!-- SVG Icon -->
                                    </i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('data_kepsek') ? 'active' : '' }}"
                                    href="{{ url('data_kepsek') }}" id="active">
                                    <i class="icon">
                                        <!-- SVG Icon -->
                                    </i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('tapel', 'libur') ? 'active' : '' }}"
                            data-bs-toggle="collapse" href="#utilities-error" role="button"
                            aria-expanded="{{ Request::is('tapel', 'libur') ? 'true' : 'false' }}"
                        ...
                        <ul class="sub-nav collapse {{ Request::is('tapel', 'libur') ? 'show' : '' }}"
                            id="utilities-error">
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('tapel') ? 'active' : '' }}"
                                    href="{{ url('tapel') }}" id="active">
                                    <i class="icon">
                                        <!-- SVG Icon -->
                                    </i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('kelola_absen*') ? 'active' : '' }}"
                            data-bs-toggle="collapse" href="#sidebar-widget" role="button"
                            aria-expanded="{{ Request::is('kelola_absen*') ? 'true' : 'false' }}"
                        ...
                        <ul class="sub-nav collapse {{ Request::is('/kelola_absen*') ? 'show' : '' }}"
                            id="sidebar-widget">
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('/kelola_absen') ? 'active' : '' }}"
                                    href="{{ url('/kelola_absen') }}" id="active">
                                    <i class="icon">
                                        <!-- SVG Icon -->
                                    </i>
                                    <i class="sidenav-mini-icon">K</i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('/admin/rekap_absen') ? 'active' : '' }}"
                                    href="{{ url('/admin/rekap_absen') }}" id="active">
                                    <i class="icon">
                                        <!-- SVG Icon -->
                                    </i>
                                    <i class="sidenav-mini-icon">A</i>
        ...
        <div class="position-relative iq-banner">
                                ...
                                <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown"
                                    ...
                                    <img src="{{ asset('img/profile.jpg') }}" alt="User-Profile"
                                        ...
                                        <div class="caption ms-3 d-none d-md-block ">
                                            <h6 class="mb-0 caption-title">yoo</h6>
            ...
            <div class="iq-navbar-header" style="height: 215px;">
                ...
                <div class="iq-header-img">
                    <img src="{{ asset('img/top-header.png') }}" alt="header"
